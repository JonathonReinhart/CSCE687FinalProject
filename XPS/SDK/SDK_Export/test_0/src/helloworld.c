...
#define AC97_VOL_STEREO_0dB     0x0808			//  0xx01000_xxx01000
...
int main()
{
    ...
    WriteAC97Reg(XPAR_OPB_AC97_CONTROLLER_0_BASEADDR, XAC97_MIC_VOLUME_REG, AC97_VOL_MUTE);

    // Set the Line In gain to 0dB.
    WriteAC97Reg(XPAR_OPB_AC97_CONTROLLER_0_BASEADDR, XAC97_LINE_IN_VOLUME_REG, AC97_VOL_STEREO_0dB);
